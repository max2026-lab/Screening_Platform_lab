...
def test_paid_order_cli_emits_landscape_scale_warning_metadata(monkeypatch, tmp_path, capsys):
    db_path = tmp_path / "paid-order-cli.sqlite3"
    ...
    assert quote_payload["paid_landscape_scale_warning"] is True
